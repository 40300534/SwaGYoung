 ...
 * @author 莫奇
 */
public class NewProductRequestBO {
    private Long id;
    ...
    private List<String> productRequestImages;
    ...
    public List<String> getProductRequestImages() {
        return productRequestImages;
    }

    public void setProductRequestImages(List<String> productRequestImages) {
        this.productRequestImages = productRequestImages;
    }
}
